...
- `skills/e2e-testing/SKILL.md` — E2E test patterns for UI testing
...
For detailed TypeScript and JavaScript patterns, use `coding-standards` plus `frontend-patterns` based on the code being reviewed.
